...
// import { WiRadar } from 'react-icons/wi';
...
export default function WeatherDashboard() {
  return (
    <div className={styles['dashboard-container']}>
      ...
      <section className={styles['left-content-card']}>
        ...
        <div className={styles['title-group']}>
          ...
          <h1 className={styles['main-title']}>
            날씨 데이터를
            <br />
            <span className={styles['white-highlight']}>화려한 시각화로.</span>
          </h1>

          <p className={styles['sub-text']}>
            사용자가 지도에서 위치를 선택하면 위경도를 기상청 격자 좌표로 변환하고,
            <br />
            단기예보 API 데이터를 Chart.js 기반 대시보드로 표현합니다.
          </p>
        </div>

        {/* 하단: 관심 지역 카드 섹션 (서울, 부산, 제주) */}
      ...
      {/* ➡️ RIGHT CONTENT AREA : 검색, 지도 프리뷰 & 2x2 메트릭 */}
